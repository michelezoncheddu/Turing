...
\begin{center}
	\begin{figure}[ht!]
		\makebox[\textwidth]{\includegraphics[width=1.4\linewidth]{screenshots/documents.png}}
		\caption{Elenco dei documenti di Dante Alighieri. Notare le icone per indicare lo stato di condivisione di un documento.}
	\end{figure}

	\begin{figure}[ht!]
		\makebox[\textwidth]{\includegraphics[width=0.70\linewidth]{screenshots/notification.png}}
	...
	\begin{figure}[ht!]
		\makebox[\textwidth]{\includegraphics[width=1.20\linewidth]{screenshots/workspace.png}}
